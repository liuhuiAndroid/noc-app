...
import com.noc.app.ui.share.ShareDialog;
                ...
                .execute(new JsonCallback<JsonObject>() {
                    ...
                    public void onSuccess(ApiResponse<JsonObject> response) {
                        if (response.body != null) {
                            ...
                            hasFavorite = response.body.get("hasFavorite").getAsBoolean();
                ...
                .execute(new JsonCallback<JsonObject>() {
                    ...
                    public void onSuccess(ApiResponse<JsonObject> response) {
                        if (response.body != null) {
                            ...
                            hasFollow = response.body.get("hasLiked").getAsBoolean();
                ...
                .execute(new JsonCallback<JsonObject>() {
                    ...
                    public void onSuccess(ApiResponse<JsonObject> response) {
                        if (response.body != null) {
                            ...
                            success = response.body.get("result").getAsBoolean();
                ...
                .execute(new JsonCallback<JsonObject>() {
                    ...
                    public void onSuccess(ApiResponse<JsonObject> response) {
                        if (response.body != null) {
                            ...
                            result = response.body.get("result").getAsBoolean();
        ...
        ApiService.get("/tag/toggleTagFollow")
                ...
                .execute(new JsonCallback<JsonObject>() {
                    ...
                    public void onSuccess(ApiResponse<JsonObject> response) {
                        if (response.body != null) {
                            Boolean follow = null;
                            follow = response.body.get("hasFollow").getAsBoolean();
