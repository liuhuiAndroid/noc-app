...
import com.noc.app.databinding.ActivityLayoutPublishBinding;
import com.noc.app.ui.fragment.TagBottomSheetDialogFragment;
import com.noc.app.workers.UploadFileWorker;
...
public class PublishActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void publish() {
        ...
        if (!TextUtils.isEmpty(filePath)) {
            if (isVideo) {
                //生成视频封面文件
                FileUtils.generateVideoCover(this, filePath).observe(this, new Observer<String>() {
