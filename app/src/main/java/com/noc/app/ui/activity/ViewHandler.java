...
import com.noc.app.adapters.FeedCommentAdapter;
import com.noc.app.data.bean.Comment;
import com.noc.app.data.bean.Feed;
import com.noc.app.databinding.LayoutFeedDetailBottomInateractionBinding;
import com.noc.app.ui.view.CommentDialog;
import com.noc.app.viewmodels.FeedDetailViewModel;
import com.noc.lib_common.utilities.PixUtils;
import com.noc.lib_common_ui.widget.EmptyView;
    ...
    public void handleEmpty(boolean hasData) {
        if (hasData) {
            ...
            if (mEmptyView == null) {
                ...
                layoutParams.topMargin = PixUtils.dp2px(mActivity,40);
