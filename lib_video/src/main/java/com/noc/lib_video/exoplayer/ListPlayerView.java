...
public class ListPlayerView extends FrameLayout implements IPlayTarget, PlayerControlView.VisibilityListener, Player.EventListener {
    ...
    public ListPlayerView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        LayoutInflater.from(context).inflate(com.noc.lib_video.R.layout.layout_player_view, this, true);

        this.context = context;
        //缓冲转圈圈的view
        bufferView = findViewById(com.noc.lib_video.R.id.buffer_view);
        //封面view
        cover = findViewById(com.noc.lib_video.R.id.cover);
        //高斯模糊背景图,防止出现两边留嘿
        blur = findViewById(com.noc.lib_video.R.id.blur_background);
        //播放盒暂停的按钮
        playBtn = findViewById(com.noc.lib_video.R.id.play_btn);
    ...
    protected void onDetachedFromWindow() {
        ...
        playBtn.setImageResource(com.noc.lib_video.R.drawable.icon_video_play);
    }
    ...
    public void onVisibilityChange(int visibility) {
        ...
        playBtn.setImageResource(isPlaying() ? com.noc.lib_video.R.drawable.icon_video_pause : com.noc.lib_video.R.drawable.icon_video_play);
    }
